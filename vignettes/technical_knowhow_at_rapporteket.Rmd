...
vignette: >
  %\VignetteIndexEntry{Technical knowhow at Rapporteket}
...
therefore be somewhat lingo agnostic...
...
```
## Løsning
Problemet kan løses ved å endre måten Rserve (daemon) startes. Følgende linje i _/etc/init.d/rserve_
```bash
