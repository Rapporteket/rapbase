...
This outlines how to propose a change to rapbase. For more detailed info
about contributing, please see the [**tidyverse development contributing
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("rapporteket/rapbase", fork = TRUE)`.
