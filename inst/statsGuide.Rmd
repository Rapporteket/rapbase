...
## Bruksanvisning
Fra menyen til høyre velg hvilket datasett som skal benyttes. Perioden er i utgangspunktet satt til hele tidsspennet i datasettet men kan endres ved behov. Utforsk datasettet ved å flytte variabler i krysstabellen til høyre. Utvalg er mulig ved å trykke på menyen for den variabelen det skal filtreres på. Datasettet kan også lastes ned som en csv fil (til bruk eksempelvis i et regneark) som da vil inneholde alle variablene for perioden som er angitt i menyen.
