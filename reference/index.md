...
- [`userAttribute()`](userAttribute.md)
  ...
  [`getUserGroups()`](userAttribute.md) [`getAppId()`](userAttribute.md)
...
- [`regTitle()`](regTitle.md) : Title on the top left of the app,
  including the logo
- [`memoryDisplay()`](memoryDisplay.md) : Display memory usage in the
  app
- [`memoryTitle()`](memoryTitle.md) : Title on the top left of the app,
  including the logo and memory usage
